...
func (c *testApiClient) CreateUser(ctx context.Context, in *User, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
...
func (UnimplementedTestApiServer) CreateUser(context.Context, *User) (*Response, error) {
...
func _TestApi_CreateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TestApiServer).CreateUser(ctx, req.(*User))
	}
